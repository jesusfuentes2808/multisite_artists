...
function listPlayListYT() {
  //ytb_content__loading
  $("#ytb_content").css('display', 'none');
  $(".ytb_content__loading").css('display', 'block');
  fetch(window.urlJson + "/" + window.alias + "/playlist_yt.json").then( /*#__PURE__*/function () {
